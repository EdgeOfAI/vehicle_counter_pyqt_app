...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(180, 355)
        MainWindow.setMinimumSize(QSize(180, 355))
        ...
        self.frame.setMinimumSize(QSize(180, 48))
        ...
        self.label.setGeometry(QRect(0, 0, 160, 41))
        ...
        self.frame_2.setMinimumSize(QSize(160, 47))
